...
from regression import DataSet, compute_single_var_models, \
  compute_all_vars_model, compute_best_pair, backward_elimination, \
...
def test_task3(test_data, dataset):
    ...
    models = backward_elimination(dataset_obj)

    check_models(test_data, dataset, "backward_elimination", models)
